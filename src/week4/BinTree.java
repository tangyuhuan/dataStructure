...
public class BinTree {
    ...
    */
    public static TreeNode1 delete(TreeNode1 root, int data) {
        if (root == null) {
            ...
            if (data < root.val) {
                ...
                if ((root.left != null) && (root.right != null)) {/*如果被删除的节点有左右两个子节点*/
                    TreeNode1 tmp = FindMin(root.right);/*在右子树中找最小的元素填充删除节点*/
                    root.val = tmp.val;
...
/*    //    查找最小元素的递归写法
    ...
    //    查找最小元素的迭代写法
    public static TreeNode1 FindMin(TreeNode1 root){
        if(root!=null){
